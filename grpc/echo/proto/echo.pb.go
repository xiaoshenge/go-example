...
// A compilation error at this line likely means your slice_copy of the
...
func (*EchoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_echo_7f217b1794d517ee, []int{0}
}
...
func (*EchoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_echo_7f217b1794d517ee, []int{1}
}
...
func (c *echoClient) BidirectionalStreamingEcho(ctx context.Context, opts ...grpc.CallOption) (Echo_BidirectionalStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Echo_serviceDesc.Streams[0], "/echo.Echo/BidirectionalStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *echoClient) ServerStreamingEcho(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (Echo_ServerStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Echo_serviceDesc.Streams[1], "/echo.Echo/ServerStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *echoClient) ClientStreamingEcho(ctx context.Context, opts ...grpc.CallOption) (Echo_ClientStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Echo_serviceDesc.Streams[2], "/echo.Echo/ClientStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("echo.proto", fileDescriptor_echo_7f217b1794d517ee) }

var fileDescriptor_echo_7f217b1794d517ee = []byte{
	...
	0x1e, 0x88, 0xc2, 0xe2, 0x82, 0xfc, 0xbc, 0xe2, 0x54, 0xdc, 0x2a, 0x8d, 0xba, 0x99, 0xb8, 0x58,
	0x40, 0x4a, 0x85, 0x4c, 0xb8, 0x38, 0x43, 0xf3, 0x12, 0x8b, 0x2a, 0xc1, 0x1c, 0x41, 0x3d, 0xb0,
	0xdd, 0x48, 0x96, 0x49, 0x09, 0x21, 0x0b, 0x41, 0x8c, 0x55, 0x62, 0x10, 0xf2, 0xe4, 0x92, 0x72,
	0xca, 0x4c, 0xc9, 0x2c, 0x4a, 0x4d, 0x2e, 0xc9, 0xcc, 0xcf, 0x4b, 0xcc, 0x09, 0x2e, 0x29, 0x4a,
	0x4d, 0xcc, 0xcd, 0xcc, 0x4b, 0x27, 0xc9, 0x18, 0x0d, 0x46, 0x03, 0x46, 0x21, 0x07, 0x2e, 0xe1,
	0xe0, 0xd4, 0xa2, 0xb2, 0xd4, 0x22, 0xf2, 0xcc, 0x80, 0x98, 0xe0, 0x9c, 0x93, 0x99, 0x9a, 0x57,
	0x42, 0xae, 0x2b, 0x92, 0xd8, 0xc0, 0xa1, 0x6d, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xea, 0xa0,
	0x2f, 0xa7, 0x7b, 0x01, 0x00, 0x00,
}
